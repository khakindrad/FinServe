...
{
    /// <inheritdoc />
    public partial class AddLoginHistoryBaseline : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Platform administrator", true, "Admin" },
                    { 2, "Internal employee", true, "Employee" },
                    { 3, "Car dealer", true, "Dealer" },
                    { 4, "Bank representative", true, "Banker" },
                    { 5, "End customer", true, "Customer" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "DeviceTokensJson", "Email", "EmailVerified", "FailedLoginCount", "FullName", "IsActive", "IsApproved", "LockoutEndAt", "MfaEnabled", "MfaSecret", "Mobile", "MobileVerified", "PasswordExpiryDate", "PasswordHash", "PasswordLastChanged", "RoleId" },
                values: new object[] { 1, null, "admin@finserve.com", true, 0, "Platform Admin", true, true, null, false, null, "9999999999", true, null, "AQClchAv7t1dq3Rmxu7xgmEK4EbByfwx4UV0RUZprlFUXnupgTMWrHczDdfQb6z3WZh6AoD2Z8Q2+y4\r\n", new DateTime(2025, 11, 9, 12, 38, 27, 228, DateTimeKind.Utc).AddTicks(8759), 1 });
