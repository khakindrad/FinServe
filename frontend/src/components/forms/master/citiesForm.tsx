...
import { AddCityDialog } from "./addCities";
...
export default function CityPage() {
    ...
    function exportData() {
        exportToExcel(cities, "Cities Details");
        ...
        <div className="p-6 flex justify-center">
            <div className="w-full max-w-7xl bg-white rounded-xl shadow-lg border">
                ...
                <div className="px-6 py-4 border-b bg-gray-50 rounded-t-xl flex justify-between items-center">
                    <h2 className="text-xl font-semibold text-gray-800">Manage Cities</h2>
            ...
            {modalOpen && (
                <AddCityDialog open={modalOpen} onClose={() => setModalOpen(false)} onSaved={reload} />
            )}
        </div>
    );
}
